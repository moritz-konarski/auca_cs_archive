...
class L05P02 extends JFrame {
    ...
    final private static String TITLE = "L05P02";
    ...
    private L05P02() {
        ...
        redButton.addActionListener(new ButtonActionListener(panel, Color.RED));
        greenButton.setBounds(xMiddle - WIDTH_BUTTON / 2, yHeight, WIDTH_BUTTON, HEIGHT_BUTTON);
        greenButton.addActionListener(new ButtonActionListener(panel, Color.GREEN));
        blueButton.setBounds(xMiddle + WIDTH_BUTTON / 2 + PADDING, yHeight, WIDTH_BUTTON, HEIGHT_BUTTON);
        blueButton.addActionListener(new ButtonActionListener(panel, Color.BLUE));
