...
//            JOptionPane.showMessageDialog(this, e.getStackTrace(), "An error occurred!", JOptionPane.ERROR_MESSAGE);;
            return false;
        } catch (CharacterException e) {
            System.err.println(e.getMessage());
            System.err.println(Arrays.toString(e.getStackTrace()));
//            JOptionPane.showMessageDialog(this, e.getMessage(),e.getReason(), JOptionPane.ERROR_MESSAGE);
            return false;
        }
    }
