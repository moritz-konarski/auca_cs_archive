%-------dialog box asking user for imput-----------
input = inputdlg ({"Amplitude", "Frequency", "Phase"},...
"Harmonic Oscillation",[1,20;1,20;1,20],{"1", "1", "0"});   %getting user imput
...
txt = [ "Modulation\ny=" num2str(A) "*sin(" num2str(w) "*t+" num2str(fi) ")"];  %preparing title string
