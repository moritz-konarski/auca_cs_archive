...
h_Line3=line(0,0);
  ...
  set(h_Line2,'xdata',[t/2 (x+t)/2],'ydata',[-3 y/2-3],'color',[0 1 0],'linewidth',[3]);
  
  set(h_Line3,'xdata',[3*t/4 3/4*(x+t)],'ydata',[-1.75 3/4*y-1.75],'color',[0 0 1],'linewidth',[3]);
...
for r=0:.3:2*pi+.1;
  ...
  line([(xd0+t)/2 (xd+t)/2],[yd0/2-3 yd/2-3],'color',[0 1 0]);
  line([3*(xd0+t)/4 3*(xd+t)/4],[3*yd0/4-1.75 3*yd/4-1.75],'color',[0 0 1]);
