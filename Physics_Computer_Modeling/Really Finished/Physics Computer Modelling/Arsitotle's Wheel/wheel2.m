...
for t=0:.1:2*pi+.1;
  ...
  set(h_Line2,'xdata',[t (x/2+t)],'ydata',[-.5 y/2-.5],'color',[0 1 0],'linewidth',[3]);
  set(h_Line3,'xdata',[t (3*x/4+t)],'ydata',[-.25 3/4*y-.25],'color',[0 0 1],'linewidth',[3]);
  ...
  line([t0 (t)],[-2 -2],'color',[0 1 0],'linewidth',[3]);
  line([t0 (t)],[-1.5 -1.5],'color',[0 0 1],'linewidth',[3]);
