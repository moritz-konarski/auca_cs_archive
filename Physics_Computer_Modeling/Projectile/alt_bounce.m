...
%------------bounce 0-----------------
for t=0:.01:1000;                     %loop for drawing the throw
  
  x=x01+v0*cos(fi)*(t-t0);                     %calculating x value
  y=v0*sin(fi)*(t-t0)-.5*g*(t-t0)^2;            %calculating y value
