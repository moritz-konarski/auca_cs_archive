...
axes('position',[.1 .1 .8 .8],'color',[1 1 1], 'xlim',[-13 13],'ylim',[-13 13],'zlim',[-1 4]);  %Creating Axis
...
%-----------------------------------------------------------------------------------------------------------------
n=3;              %Number of Revolutions of earth/number of years shown (>=3)
i=.05;            %Interval during for-loop
%----To adapt this system, set angular speed and radius for the sun to the ones of the desired planet
...
for t=0:i:l                                          %setting up loop for one rotation
  ...
  if (mod(t,0.5.*i)==0)     %Trails of Planets
    ...
    line(xem-xs,yem-ys,z,'marker','.','markersize',[7]); %Moon
    line(xma-xs,yma-ys,z,'marker','.','markersize',[7]);   %Mars
    line(xmam-xs,ymam-ys,z,'marker','.','markersize',[7]); %Marsmoon
    line(xj-xs,yj-ys,z,'marker','.','markersize',[7]);   %Jupiter
    line(xmj1-xs,ymj1-ys,z,'marker','.','markersize',[7]); %Jupiter Moon one
    line(xmj2-xs,ymj2-ys,z,'marker','.','markersize',[7]); %Jupiter Moon two
    line(xmj3-xs,ymj3-ys,z,'marker','.','markersize',[7]); %Jupiter Moon three
    line(xmj4-xs,ymj4-ys,z,'marker','.','markersize',[7]); %Jupiter Moon four
