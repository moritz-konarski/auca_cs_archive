...
%------------preparation-----------------------------------------------------------------------------------------
figure('units','norm','position',[.1 .1 .8 .7],'color',[.9 .9 .9],'name', "Jupiter-Centric"); %Creating Window
axes('position',[.1 .1 .8 .8],'color',[1 1 1], 'xlim',[-20 20],'ylim',[-20 20]);  %Creating Axis
