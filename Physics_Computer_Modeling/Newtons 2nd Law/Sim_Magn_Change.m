...
axis('equal',[-1 26 -11 11 ]);                                                  %setting axis limits based on radius of circle ,[-1 10 -5 5 -5 5]
h_center1=line(0,0,'marker','o', 'markersize',[10],'color','red',...
              'markerfacecolor','red');                                         %setting a ball to  center circle
%h_center2=line(0,0,'marker','o', 'markersize',[10],'color','red',...
              %'markerfacecolor','red');                                         %setting a ball to  center circle
...
for t=0:dt:limt;                              %loop from 0 to limt with interval dt
  ...
  %line([-x0  -x],[y y0],[z z0],'linewidth',[2]);%line of x and y
  %set(h_center2,'xdata',-x,'ydata',y,'zdata',z);  %setting the ball to the center
