...
int main(int argc, char **argv) {
    ...
    // rectangles
    auto rectangle1 = generate_rectangle_mesh(RECTANGLE_SIDE_LENGTH, RECTANGLE_SIDE_LENGTH,
                                              NAME_RECTANGLE_1, POSITION_RECTANGLE_1, COLOR_ARRAY,
                                              SMALL_SEGMENT_COUNT, SMALL_SEGMENT_COUNT,
                                              Geometry::Type::Triangles, constant_material);

    auto rectangle2 = generate_rectangle_mesh(RECTANGLE_SIDE_LENGTH, RECTANGLE_SIDE_LENGTH,
                                              NAME_RECTANGLE_2, POSITION_RECTANGLE_2, COLOR_ARRAY,
                                              MEDIUM_SEGMENT_COUNT, MEDIUM_SEGMENT_COUNT,
                                              Geometry::Type::LineLoop, constant_material);

    auto rectangle3 = generate_rectangle_mesh(RECTANGLE_SIDE_LENGTH, RECTANGLE_SIDE_LENGTH,
                                              NAME_RECTANGLE_3, POSITION_RECTANGLE_3, COLOR_ARRAY,
    ...
    auto circle2 = generate_circle_mesh(RADIUS_CIRCLE, NAME_CIRCLE_2, POSITION_CIRCLE_2,
                                        COLOR_ARRAY, MEDIUM_SEGMENT_COUNT, Geometry::Type::LineLoop,
                                        constant_material);

    auto circle3 = generate_circle_mesh(RADIUS_CIRCLE, NAME_CIRCLE_3, POSITION_CIRCLE_3,
                                        COLOR_ARRAY, HIGH_SEGMENT_COUNT, Geometry::Type::Points,
                                        constant_material);

    // spheres
    auto sphere1 = generate_sphere_mesh(RADIUS_SPHERE, NAME_SPHERE_1, POSITION_SPHERE_1,
                                        COLOR_ARRAY, SMALL_SEGMENT_COUNT, RING_COUNT_SPHERE,
                                        Geometry::Type::Triangles, constant_material);

    auto sphere2 = generate_sphere_mesh(RADIUS_SPHERE, NAME_SPHERE_2, POSITION_SPHERE_2,
                                        COLOR_ARRAY, MEDIUM_SEGMENT_COUNT, RING_COUNT_SPHERE,
                                        Geometry::Type::LineLoop, constant_material);

    auto sphere3 = generate_sphere_mesh(RADIUS_SPHERE, NAME_SPHERE_3, POSITION_SPHERE_3,
                                        COLOR_ARRAY, HIGH_SEGMENT_COUNT, RING_COUNT_SPHERE,
                                        Geometry::Type::Points, constant_material);

    std::vector<std::shared_ptr<Object>> objects{rectangle1, rectangle2, rectangle3, circle1,
                                                 circle2, circle3, sphere1, sphere2, sphere3};
    ...
    for (;;) {
        ...
        rectangle2->add_to_rotation(glm::vec3(0.0f, ROTATION_SPEED_GEOMETRIES,
                                              ROTATION_SPEED_GEOMETRIES));
        rectangle3->add_to_rotation(glm::vec3(ROTATION_SPEED_GEOMETRIES, -ROTATION_SPEED_GEOMETRIES,
                                              0.0f));
        ...
        circle2->add_to_rotation(glm::vec3(0.0f, ROTATION_SPEED_GEOMETRIES,
                                           ROTATION_SPEED_GEOMETRIES));
        circle3->add_to_rotation(glm::vec3(ROTATION_SPEED_GEOMETRIES, -ROTATION_SPEED_GEOMETRIES,
                                           0.0f));
        ...
        sphere2->add_to_rotation(glm::vec3(0.0f, ROTATION_SPEED_GEOMETRIES,
                                           ROTATION_SPEED_GEOMETRIES));
        sphere3->add_to_rotation(glm::vec3(ROTATION_SPEED_GEOMETRIES, -ROTATION_SPEED_GEOMETRIES,
                                           0.0f));
