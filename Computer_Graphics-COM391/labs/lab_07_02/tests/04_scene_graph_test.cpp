...
int main(int argc, char **argv) {
    ...
    auto main_sphere = generate_sphere_mesh(RADIUS_MAIN_SPHERE, NAME_MAIN_SPHERE,
                                            ORIGIN_POSITION,
                                            COLOR_MAIN_SPHERE, COUNT_VERTEX,
                                            COUNT_SPHERE_RING,
    ...
    auto small_circle_base = generate_circle_mesh(RADIUS_SMALL_CIRCLE,
                                                  "small circle base",
                                                  ORIGIN_POSITION, COLOR_SMALL_CIRCLE,
                                                  COUNT_VERTEX,
                                                  Geometry::Type::TriangleFan,
                                                  constant_material);

    auto medium_circle_base = generate_circle_mesh(RADIUS_MEDIUM_CIRCLE,
                                                   "medium circle base",
    ...
    generate_circle_of_circle_meshes(main_sphere, medium_circle_base,
                                     ...
                                     COUNT_MEDIUM_CIRCLES,
                                     MODULUS_MEDIUM_CIRCLES, -Z_OFFSET);
    // square_base 15 minute marks
    generate_ring_of_square_meshes(main_sphere, square_base,
                                   RADIUS_CLOCK + RADIUS_OFFSET_SQUARE,
    ...
    auto second_hand = generate_rectangle_mesh(WIDTH_SECOND_HAND, LENGTH_SECOND_HAND,
                                               NAME_SECOND_HAND, ORIGIN_POSITION,
                                               COLOR_SECOND_HAND,
                                               COUNT_VERTEX, COUNT_VERTEX,
                                               Geometry::Type::TriangleFan,
                                               constant_material);
    ...
    auto minute_hand = generate_rectangle_mesh(WIDTH_MINUTE_HAND, LENGTH_MINUTE_HAND,
                                               ...
                                               COLOR_MINUTE_HAND, COUNT_VERTEX,
                                               COUNT_VERTEX,
                                               Geometry::Type::TriangleFan,
                                               constant_material);
    // create hour hand
    auto hour_hand = generate_rectangle_mesh(WIDTH_HOUR_HAND, LENGTH_HOUR_HAND,
                                             NAME_HOUR_HAND,
                                             ORIGIN_POSITION, COLOR_HOUR_HAND,
                                             COUNT_VERTEX,
