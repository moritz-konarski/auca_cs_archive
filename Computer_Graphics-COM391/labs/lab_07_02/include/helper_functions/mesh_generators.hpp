    ...
    namespace mesh_generators {
        ...
        generate_triangle_mesh(float size, std::string name, glm::vec3 position,
            ...
            for (int i = 0; i < triangle_vertices.second.size(); ++i) {
                triangle_vertices.second[i].color = color_array.at(
        ...
        std::shared_ptr<Mesh>
        generate_rectangle_mesh(float width, float height, std::string name,
                                glm::vec3 position,
                                std::vector<glm::vec4> color_array,
            ...
            for (int i = 0; i < rectangle_vertices.second.size(); ++i) {
                rectangle_vertices.second[i].color = color_array.at(
                        i % color_array_length);
            }
            ...
            auto rectangle = std::make_shared<Mesh>(rectangle_geometry, material,
                                                    position);
