...
namespace aur {
    ...
    public:
        ...
        void
        set_receive_aspect_ratio_from_renderer(bool receive_aspect_ratio_from_renderer) {
        ...
        void
        set_projection_matrix_requires_update(bool projection_matrix_requires_update) {
        ...
        void
        set_view_projection_matrix_requires_update(
