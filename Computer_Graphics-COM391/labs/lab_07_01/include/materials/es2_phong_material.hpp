...
namespace aur {
    ...
    public:
        ES2PhongMaterial() {
            ...
            _shader = std::make_shared<ES2Shader>(_vertex_shader_source, _fragment_shader_source,
                                                  attributes, uniforms);
        }
        ...
        void update(std::shared_ptr<Scene> scene, std::shared_ptr<Mesh> mesh) final {
            ...
            for (std::vector<std::shared_ptr<DirectionalLight>>::size_type i = 0;
                ...
                glUniform3fv(
                        ...
                        1, glm::value_ptr(camera->get_view_matrix() *
                                          glm::vec4(directional_light->get_world_direction(), 0.0f))
                );
            ...
            for (std::vector<std::shared_ptr<PointLight>>::size_type i = 0;
                ...
                glUniform3fv(
                        uniform_location,
                        1, glm::value_ptr(
                                camera->get_view_matrix() * point_light->get_world_matrix() *
            ...
            for (std::vector<std::shared_ptr<SpotLight>>::size_type i = 0;
                ...
                glUniform3fv(
                        uniform_location,
                        1, glm::value_ptr(
                                camera->get_view_matrix() * spot_light->get_world_matrix() *
                ...
                glUniform3fv(
                        uniform_location,
                        1, glm::value_ptr(camera->get_view_matrix() *
                                          glm::vec4(spot_light->get_world_direction(), 0.0f))
                );
