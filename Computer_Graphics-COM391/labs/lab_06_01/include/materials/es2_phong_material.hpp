/*
 * defines all the necessary functions to send data to the shader
 * computes all the stuff for all the lights
 */
...
namespace aur {
    ...
    public:
        ES2PhongMaterial() {
            _vertex_shader_source = FileUtilities::read_text_file(
                    "../data/shaders/es2_phong_shader.vert");
            _fragment_shader_source = FileUtilities::read_text_file(
