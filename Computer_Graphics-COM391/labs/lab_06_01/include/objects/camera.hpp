/*
 * defines camera, and object that also has the different view and projection stuff
 */
#ifndef CAMERA_HPP
#define CAMERA_HPP
...
namespace aur {
    ...
    public:
        ...
        void
        set_view_projection_matrix_requires_update(bool view_projection_matrix_requires_update) {
