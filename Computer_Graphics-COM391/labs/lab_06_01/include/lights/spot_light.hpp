/*
 * child class of light, implements stuff a spot light needs
 */
...
namespace aur {
    ...
    public:
        ...
        void set_use_constant_linear_quadratic_attenuation(
                bool use_constant_linear_quadratic_attenuation) {
        ...
        void set_direction(const glm::vec3 &direction) {
            ...
            _world_direction = glm::vec3(
                    glm::normalize(get_world_matrix() * glm::vec4(_direction, 0.0f)));
        }
