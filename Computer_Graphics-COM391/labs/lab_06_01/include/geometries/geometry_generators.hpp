/*
 * generates different types of geometries as pairs of indices and vertices
 * for rectanlges and spheres the indices need to be adjusted accordingly
 */
...
namespace aur {
    namespace geometry_generators {
        ...
        generate_triangle_geometry_data(float size = 1.0f) {
