/*
 * contains enum for type of vertex connection,
 * geometry is made up of indices and vertices
 * contains line width
 * update and bind for implementation in specific classes
 */
#ifndef GEOMETRY_HPP
#define GEOMETRY_HPP
        ...
        void transform(glm::mat4 transformation_matrix) {
            for (auto &vertex : _vertices) {
                vertex.position = glm::vec3(
                        transformation_matrix * glm::vec4(vertex.position, 1.0f));
            }
        }
