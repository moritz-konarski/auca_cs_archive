    ...
    public:
        ES2ConstantMaterial() {
            std::string vertex_shader_source{
                    file_utilities::read_text_file(
                            "../data/shaders/es2_constant_shader.vert")};
            std::string fragment_shader_source{
                    file_utilities::read_text_file(
                            "../data/shaders/es2_constant_shader.frag")};
            ...
            _shader = std::make_shared<ES2Shader>(vertex_shader_source,
                                                  fragment_shader_source, attributes,
                                                  uniforms);
        }
        ...
        void update(std::shared_ptr<Scene> scene, std::shared_ptr<Mesh> mesh) final {
            ...
            if (_face_culling_enabled) {
                glCullFace(_convert_cull_face_mode_to_es2_cull_face_mode(
                        _cull_face_mode));
                glCullFace(_convert_front_face_order_to_es2_front_face_order(
                        _front_face_order));
            }
            ...
            int emission_color_uniform_location{
                    _shader->get_uniforms().at("emission_color")};
            glUniform4fv(
