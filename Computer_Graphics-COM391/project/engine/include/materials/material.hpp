...
namespace aur {
    ...
    public:
        ...
        void
        set_prefer_line_width_from_geometry(bool prefer_line_width_from_geometry) {
        ...
        void
        set_prefer_point_size_from_geometry(bool prefer_point_size_from_geometry) {
        ...
        void set_source_color_blending_function(
                BlendingFunction source_color_blending_function) {
        ...
        void set_source_alpha_blending_function(
                BlendingFunction source_alpha_blending_function) {
            _source_alpha_blending_function = source_alpha_blending_function;
        }

        [[nodiscard]] BlendingFunction
        get_destination_color_blending_function() const {
            return _destination_color_blending_function;
        }

        void set_destination_color_blending_function(
                BlendingFunction destination_color_blending_function) {
            _destination_color_blending_function = destination_color_blending_function;
        }

        [[nodiscard]] BlendingFunction
        get_destination_alpha_blending_function() const {
            return _destination_alpha_blending_function;
        }

        void set_destination_alpha_blending_function(
                BlendingFunction destination_alpha_blending_function) {
        ...
        [[nodiscard]] bool is_phong_material() const {
            return _is_phong_material;
        }
        ...
        virtual void
        update(std::shared_ptr<Scene> scene, std::shared_ptr<Mesh> mesh) = 0;

        virtual void use() = 0;

    protected:
        bool _is_phong_material{false};
