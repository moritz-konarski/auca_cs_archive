...
namespace aur {
    ...
    public:
        ...
        [[nodiscard]] const std::shared_ptr<AmbientLight> &
        get_ambient_light() const {
        ...
        [[nodiscard]] const std::vector<std::shared_ptr<DirectionalLight>> &
        get_directional_lights() const {
            return _directional_lights;
        }

        [[nodiscard]] const std::vector<std::shared_ptr<PointLight>> &
        get_point_lights() const {
            return _point_lights;
        }

        [[nodiscard]] const std::vector<std::shared_ptr<SpotLight>> &
        get_spot_lights() const {
            return _spot_lights;
        }
