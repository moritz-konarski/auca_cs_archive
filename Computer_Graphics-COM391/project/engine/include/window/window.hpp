...
namespace aur {
    ...
    public:
        ...
        [[nodiscard]] const std::function<void(int, int, int, int)> &
        get_on_mouse_move() const {
            return _on_mouse_move;
        }

        void set_on_mouse_move(
                const std::function<void(int, int, int, int)> &on_mouse_move) {
            _on_mouse_move = on_mouse_move;
        }

        [[nodiscard]] const std::function<void(int, int, int)> &
        get_on_mouse_down() const {
            return _on_mouse_down;
        }

        void
        set_on_mouse_down(const std::function<void(int, int, int)> &on_mouse_down) {
