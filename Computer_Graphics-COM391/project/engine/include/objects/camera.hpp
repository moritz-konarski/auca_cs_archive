...
namespace aur {
    ...
    public:
        ...
        void
        set_model_matrix_requires_update(bool model_matrix_requires_update) final {
        ...
        void
        set_world_matrix_requires_update(bool world_matrix_requires_update) final {
        ...
        Ray world_ray_from_screen_point(int x, int y, int width, int height) {
            ...
            near = glm::unProject(near, get_view_matrix(), get_projection_matrix(),
                                  viewport);

            glm::vec3 far = glm::vec3(screen_point, 1.0f);
            far = glm::unProject(far, get_view_matrix(), get_projection_matrix(),
                                 viewport);
