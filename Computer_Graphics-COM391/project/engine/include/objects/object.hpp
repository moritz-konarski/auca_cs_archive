    ...
    public:
        explicit Object(
                ...
                : _name{std::move(name)},
                  ...
                  _world_position(position), _world_rotation(rotation),
                  _world_scale(scale),
        ...
        get_child(std::vector<std::shared_ptr<Object>>::size_type position) const {
        ...
        void look_at(const glm::vec3 &position, const glm::vec3 &up) {
            ...
            glm::quat target_world_quaternion_rotation = glm::quatLookAt(direction,
                                                                         up);

            if (const auto parent = _parent.lock()) {
                glm::quat parent_world_quaternion_rotation_inverse = glm::inverse(
                        parent->get_world_quaternion_rotation());
                glm::quat quaternion_rotation =
                        parent_world_quaternion_rotation_inverse *
                        target_world_quaternion_rotation;
        ...
        void billboard_toward_camera(const std::shared_ptr<Object> &camera) {
            ...
            if (const auto parent = _parent.lock()) {
                glm::mat4 parent_world_matrix = glm::inverse(
            ...
            glm::decompose(model_matrix, scale, quaternion_rotation, position, skew,
                           perspective);
    ...
    protected:
        ...
        void _update_world_matrix_if_necessary() {
            if (_world_matrix_requires_update) {
                ...
                float sqx = _world_quaternion_rotation[0] *
                            _world_quaternion_rotation[0];
                float sqy = _world_quaternion_rotation[1] *
                            _world_quaternion_rotation[1];
                float sqz = _world_quaternion_rotation[2] *
                            _world_quaternion_rotation[2];
                float sqw = _world_quaternion_rotation[3] *
                            _world_quaternion_rotation[3];

                _world_rotation.x =
                        atan2f(
                                2.0f * (_world_quaternion_rotation[0] *
                                        _world_quaternion_rotation[3] -
                                        _world_quaternion_rotation[1] *
                                        _world_quaternion_rotation[2]),
                                sqw - sqx - sqy + sqz
                ...
                _world_rotation.z =
                        atan2f(
                                2.0f * (_world_quaternion_rotation[2] *
                                        _world_quaternion_rotation[3] -
                                        _world_quaternion_rotation[0] *
                                        _world_quaternion_rotation[1]),
                                sqw + sqx - sqy - sqz
        ...
        void _update_rotation_from_quaternion() {
            ...
            _rotation.x =
                    atan2f(
                            2.0f *
                            (normalized_quaternion[0] * normalized_quaternion[3] -
            ...
            _rotation.z =
                    atan2f(
                            2.0f *
                            (normalized_quaternion[2] * normalized_quaternion[3] -
